...
<div><h3><?php echo $info->insurance ?></h3><br>
    <a href=""><p class="p-group"><?php echo $info->medicalinsurance ?></p></a><br>
    <a href=""><p class="p-group"><?php echo $info->businessinsurance ?></p></a><br>
    <a href=""><p class="p-group"><?php echo $info->carinsurance ?></p></a><br>
